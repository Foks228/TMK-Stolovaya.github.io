function showPopup() {
    if (!sessionStorage.getItem('visitedBefore') || window.performance.navigation.type === 1) { 
    ...
    sessionStorage.setItem('visitedBefore', true); // Сохраняем информацию о том, что пользователь уже посетил сайт
}
